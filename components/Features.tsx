        ...
        <div>
            ...
            <Reveal className="mb-12 mt-8 md:mt-12 lg:mt-30 min-[1560px]:mt-40"> {/* Las pizzas mas pedidas */}
                <div className="text-center">
                    <h2 className="text-4xl lg:text-7xl md:text-6xl text-secondary/60 ">Las más pedidas</h2>
            ...
            <Reveal className="mb-4 mt-8 md:mt-12 lg:mt-30 min-[1560px]:mt-40"> {/* Testimonios de clientes */}
                <div className="text-center">
                    <h2 className="text-4xl lg:text-7xl md:text-6xl  text-secondary/60">Opiniones de nuestros clientes</h2>
                </div>
